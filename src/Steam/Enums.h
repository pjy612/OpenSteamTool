...
// All steamclient enums (small interface enums plus the giant EResult and
// EMsg enums). Pulled out of steam.h so consumers that only need an enum
// don't have to drag in struct definitions.
...
enum ERegistrySubTree
{
	...
	k_ERegistrySubTreeLegacyCDKeys = 9,
	k_ERegistrySubTreeClientConfig = 10,
};

enum EKeyValuesType : unsigned int
{
	KV_TYPE_NONE = 0,
	KV_TYPE_STRING = 1,
	KV_TYPE_INT = 2,
